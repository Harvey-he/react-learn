...
var ProductTable = React.createClass({displayName: "ProductTable",
      ...
      render: function() {
        ...
        this.props.products.forEach(function(product) {
            ...
            if (product.category !== lastCategory) {
              rows.push( React.createElement(ProductCategoryRow, {category: 
                  product.category, 
              ...
              rows.push( React.createElement(ProductRow, {product: 
                  product, 
            ...
            return ( React.createElement("table", null, 
              ...
              React.createElement("th", null, " Name "), " ", React.createElement("th", null, " Price "), " "), " "), " ", React.createElement("tbody", null, " ", 
                rows, 
              " "), " ")
            );
          }
      ...
      var FilterableProductTable = React.createClass({displayName: "FilterableProductTable",
        ...
        render: function() {
          return ( React.createElement("div", null, 
            React.createElement(SearchBar, {filterText: 
            ...
            ), " ", React.createElement(ProductTable, {products: 
              this.props.products, 
      ...
      React.render( React.createElement(FilterableProductTable, {products: 
          PRODUCTS
        }
